...
var Transducer$TransducersRe = require("./Transducer.bs.js");
...
function countAdultsWithInitial$1(initial) {
  var g = function (param, param$1, param$2) {
    return Transducer$TransducersRe.map((function (param) {
                  return 1;
...
function enumerateAdultsWithInitial(initial) {
  ...
  return adultsWithInitial(initial, (function (param, param$1) {
                return Transducer$TransducersRe.map((function (person) {
                              return person.name;
                            }), x, param, param$1);
              }));
}
